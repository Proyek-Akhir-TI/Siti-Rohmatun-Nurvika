...
{{-- gambar det 1 --}}
          ...
          <div class="col-md-6 col-lg-5 p-b-30">
            <div class="p-r-50 p-t-5 p-lr-0-lg">
              ...
              <span class="mtext-106 cl2">Rp.{{$produk->harga}}</span>
              ...
              <p class="stext-102 cl3 p-t-23">Stok: {{$produk->stok}}</p>
                ...
                @if (auth()->user() == NULL)
                <a onclick="alert('Silahkan Login terlebih dahulu')" href="{{ route('login') }}" class="text-left btn btn-block btn-sm mt-3" style="background-color: rgb(208, 208, 221); border-radius: 8px;">
                ...
                @endif
                 ...
                 <form action="{{route('keranjangStore')}}" method="post">
                    @csrf
                    <input type="hidden" name="produk_id" value="{{$produk->id}}">
                    <button class="text-left btn btn-block btn-sm mt-3" type="submit" style="background-color: rgb(208, 208, 221); border-radius: 8px;">
                        <span class="mtext-110 cl2 js-name-detail p-b-10" >
                            Masukkan Keranjang
                        </span>
                    </button>
