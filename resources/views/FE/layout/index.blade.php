    ...
    <div class="container-menu-desktop">
      ...
      <div class="wrap-menu-desktop">
        <nav class="limiter-menu-desktop container">
          <!-- Logo desktop -->
          <a href="#" class="logo">
            <img src="https://i.ibb.co/7XtRghP/logo-1.png" alt="IMG-LOGO" />
       </a>
          ...
          <div class="wrap-icon-header flex-w flex-r-m">
            <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-account">
              <a href="{{ route('login') }}"><i class="zmdi zmdi-account-circle" style="color:grey"></i></a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <div class="container">
      ...
      <div class="p-t-40">
        ...
        <p class="stext-107 cl6 txt-center">
          ...
          All rights reserved h <i class="fa fa-heart-o" aria-hidden="true"></i>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>
    </div>
